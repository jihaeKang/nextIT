...
public class FileBasic {
	...
	public static void main(String[] args) {
		...
		File ramen = new File(path + "/src/ch10_extends_interface/ramen");
		...
		File today = new File("/home/pc10/today");
		...
		// 파일 만들기
		// /home/pc10/today 안에 test.txt 파일 만들기
		File test = new File("/home/pc10/today/test.txt");
		...
		for(int i = 0; i < stuArray.length; i++) {
			File temp = new File("/home/pc10/today/" + stuArray[i]);
			temp.mkdir();
		}
