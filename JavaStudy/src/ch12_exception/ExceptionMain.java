...
public class ExceptionMain {
	...
	public static void main(String[] args) {
		...
		// 예외 상황에서 예외처리를 해주어야 우리가 만든 에러페이지라도 보여줄 수 있다.
		...
		// 일반적으로 예외처리는 충분한 테스트 이후 개발 말기에 적용
...
//		}
		...
		// 충분히 예측되는 예외의 경우 따로 exception 클래스를 만들어서 다룬다.
		// 비즈니스 Exception -> BizException
		
		ExMethod.indexing(intArray);
		
		// 에러 처리를 해줘야하기 때문에 해당 메소드를 최종적으로 실행하는 곳에서는
		// try - catch를 해주어야 한다.
		try {
		...
		System.out.println(ExMethod.dateMillSec("2023-04-01"));
		
		System.out.println("\n=====================================\n");
		
		try {
			ExMethod.printName("지혜");
