...
public class starCraftMain {
	...
	public static void main(String[] args) {
		...
		HighTemplar higrTemplar = new HighTemplar();
		System.out.println(higrTemplar);
		
		higrTemplar.tthunderStorm();
...
//		protossList.add(highTemplar);
		...
		StarUnit highTemplar1 = higrTemplar;
		...
		// starList는 StarUnit의 자식 객체들을 다 담을 수 이싿.
		// 담기면서 자동형변환 되어 담
		starList.add(zealot);
		starList.add(zealot2);
		starList.add(zealot3);
		starList.add(zealot4);
		starList.add(higrTemplar);		
