...
public class MySortMain {
	...
	public static void main(String[] args) {
		...
		stuList.add(new Student("민경", 86, 86, 76));
		stuList.add(new Student("혜라", 81, 85, 71));
		stuList.add(new Student("현진", 88, 82, 97));
		
		// 이게 뭐지?? -> 콜백함수
		// 인터페이스(Comparator)의 추상메소드(compare)를 미리 다른 메소드(sort)에서 사용하고,
		// 추상메소드(compare)의 구현은 해당 메소드(sort)를 실행하는 쪽에서 구현한다.
