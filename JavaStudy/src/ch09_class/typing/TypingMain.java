...
public class TypingMain {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> wordList = dictionery.makewordList(dictionery.OPTION_STUDENT_NAME);
		System.out.println(dictionery.OPTION_STUDENT_NAME);
		
		
		
		// 인덱스 0번이 삭제되면서 다음꺼가 0번이 돼서 반복됨
		
		// 현재 시간 저장
		// 1970년 1월 1일을 기준으로 현재까지 경과된 시간을 밀리초 단위로 리턴 (1초 = 1000밀리초)
		...
		// 초 단위로 변환
		// 31872밀리초 -> 31.872초
		double result = diff / 1000.0; // 31.0 안되게 하려고 변환
