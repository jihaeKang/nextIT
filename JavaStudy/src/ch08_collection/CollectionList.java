...
public class CollectionList {
	...
	public static void main(String[] args) {
		...
		// 참조타입들 = 객체
//		ArrayList<int> intList = new ArrayList<>();  // 오류남
		...
		// Wrapper 클래스 객체에 저장된 값을 기본타입의 데이터로 꺼내기
		// = 언박싱(unboxing)
		...
		// 한줄 요약
		// 오토 박싱과 언박싱이 알아서 잘 되므로, 우리가 Wrapper Class를 사용하는데 불편함은 전혀 없다.
		...
		// syso에 컬렉션 객체를 넣으면, 자동으로 내부 값이 출력된다(배열은 안됨)
...
//		students.add(13); 스트링 제너릭에 숫자 안들어감
		...
		//.contains(값)
		// 리스트 안에 해당 값이 존재하면 true 리턴, 존재하지 않으면 false 리턴
		...
		// 람다식인데 명령어가 여러줄이면 중괄호 블록 만들어주어야 한다.
		students.forEach(t -> {
			System.out.println(t);
			System.out.println(t);
		});
